...
use mermshaus\Stream\ConsumableInterface;
use mermshaus\Stream\ConsumableTrait;
use mermshaus\Stream\Matcher\Matcher;
use mermshaus\Stream\SeekableStream;

/**
 *
 */
class PdfStream extends SeekableStream implements ConsumableInterface
{
    use ConsumableTrait;
